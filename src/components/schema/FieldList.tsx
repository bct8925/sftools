    ...
    return (
        <div ref={containerRef} className={styles.fieldsPanel} data-testid="schema-fields-panel">
                ...
                <div className={styles.fieldsHeaderTop}>
                    ...
                    <div className={styles.fieldsHeaderActions}>
                        <ButtonIcon
                            ...
                            onClick={onRefresh}
                            data-testid="schema-refresh-fields"
                        />
                        <button
                            className={styles.closeBtn}
                            onClick={onClose}
                            title="Close"
                            data-testid="schema-close-fields"
                        >
                            <SfIcon name="close" />
                        </button>
                    </div>
            ...
            <div className={styles.fieldsList} data-testid="schema-fields-list">
                {isLoading ? (
                    <div className={styles.loadingContainer} data-testid="schema-fields-loading">
                        Loading fields...
                    </div>
...
const FieldItem = memo(function FieldItem({
    ...
    const { isRequired, hasPicklist, sizeDisplay, properties } = useMemo(() => {
        ...
        const size =
            STRING_TYPES.has(field.type) && field.length > 0
                ? String(field.length)
    ...
    return (
        <>
            ...
            >
                <div
                    className={styles.fieldItemLabel}
                    data-testid="schema-field-label"
                    title={field.label}
                >
                    {field.label}
                </div>
                ...
                <div className={styles.fieldItemActions}>
                    ...
                    {isFormulaField && (
                        <>
                            ...
                            />
                            <div
                                className={`${styles.fieldMenu}${isMenuOpen ? ` ${styles.show}` : ''}`}
                            >
                                ...
                                <span className={styles.propertyTags}>
                                    {properties.map(prop => (
                                        <span
                                            ...
                                            data-testid="schema-field-property-tag"
                                        >
                                            {prop}
                                        </span>
                                    ))}
