...
export function ObjectList({
    ...
    return (
        <div
            ref={panelRef}
            className={`${styles.objectsPanel}${selectedObjectName ? ` ${styles.withFields}` : ''}`}
        >
            <div className={styles.objectsHeader}>
                ...
                <div className={styles.objectsHeaderRow}>
                    <div className={styles.objectCount} data-testid="schema-object-count">
                        {countText}
                    </div>
                    <ButtonIcon
                        icon="refresh"
                        ...
                        onClick={onRefresh}
                        data-testid="schema-refresh-objects"
                    />
                </div>
            </div>
            ...
            <div ref={listRef} className={styles.objectsList} data-testid="schema-objects-list">
                {isLoading ? (
                    <div className={styles.loadingContainer} data-testid="schema-objects-loading">
                        Loading objects...
                    </div>
 ...
 */
export function scrollToObject(listRef: React.RefObject<HTMLDivElement>, objectName: string): void {
    if (listRef.current) {
