...
import { clearDescribeCache } from '../../api/salesforce';
    ...
    return (
        <div>
            <p className={styles.description}>
                SObject definitions are cached locally for faster performance. Refresh if schema
            ...
            <div className={styles.cacheRow}>
                ...
                {status && (
                    <span
                        className={`${styles.cacheStatus} ${statusType ? styles[statusType] : ''}`}
                    >
                        {status}
                    </span>
                )}
