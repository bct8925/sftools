        ...
        <div>
            ...
            {proxyEnabled && (
                <div className={styles.proxyStatus}>
                    ...
                    {version && <div className={styles.versionInfo}>Proxy version: {version}</div>}
                </div>
            )}
            ...
            <details className={styles.instructions}>
                ...
                <p>
                    To allow the Chrome extension to make requests to your Salesforce org, add a
                    CORS entry:
                </p>
                <ol>
                    ...
                    <li>
                        Enter: <code>chrome-extension://lhkfhpookakmejcjfanegicfcdcmmoca</code>
                    </li>
                    <li>Save the CORS entry</li>
                </ol>
                <p>
                    <strong>Note:</strong> When the local proxy is enabled, CORS restrictions are
                    bypassed automatically and this configuration is not required.
                </p>
            </details>
        </div>
    );
