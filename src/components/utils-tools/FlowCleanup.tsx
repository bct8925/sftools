...
import { searchFlows, getFlowVersions, deleteInactiveFlowVersions } from '../../api/salesforce';
    ...
    return (
        <div className="card" data-testid="flow-cleanup">
            <div className="card-header">
                <div className={`card-header-icon ${styles.headerIcon}`}>F</div>
                <h2>Flow Version Cleanup</h2>
            </div>
            <div className="card-body">
                <p className={sharedStyles.toolDescription}>
                    Delete inactive flow versions to reduce metadata size.
                </p>
                <SearchBox
                ...
                {status && (
                    <div className={sharedStyles.toolStatus} data-testid="flow-cleanup-status">
                        ...
                        <span
                            className={sharedStyles.toolStatusText}
                            data-testid="flow-cleanup-status-text"
                        >
                            {status.message}
                        </span>
                    </div>
