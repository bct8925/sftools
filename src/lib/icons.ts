...
import processIcon from '@salesforce-ux/icons/dist/salesforce-lightning-design-system-icons/utility/process.svg?raw';
...
export const icons = {
    ...
    tileJobs: processSvg(processIcon, { size: 32 }),
    tileSettings: processSvg(settingsIcon, { size: 24 }),

    // Home screen action icons
    openOrg: processSvg(salesforce1Icon, { size: 24 }),
